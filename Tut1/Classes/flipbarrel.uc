...
#exec MESH  MODELIMPORT MESH=skbarrelMesh MODELFILE=..\hpmodels\models\skbarrelMesh.PSK LODSTYLE=10
#exec MESH  ORIGIN MESH=skbarrelMesh X=0 Y=0 Z=0 YAW=0 PITCH=0 ROLL=0
#exec ANIM  IMPORT ANIM=skbarrelAnims ANIMFILE=..\hpmodels\models\skbarrelAnims.PSA COMPRESS=1 MAXKEYS=999999 IMPORTSEQS=1
...
#EXEC TEXTURE IMPORT NAME=skbarrelTex0  FILE=..\hpmodels\TEXTURES\skbarrelTex0.bmp  GROUP=Skins
