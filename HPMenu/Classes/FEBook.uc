...
#EXEC TEXTURE IMPORT NAME=FEBookTexture1	 FILE=TEXTURES\FEBookTexture1.bmp GROUP="Icons" FLAGS=1 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEBookTexture2	 FILE=TEXTURES\FEBookTexture2.bmp GROUP="Icons" FLAGS=1 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEBookTexture3	 FILE=TEXTURES\FEBookTexture3.bmp GROUP="Icons" FLAGS=1 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEBookTexture4	 FILE=TEXTURES\FEBookTexture4.bmp GROUP="Icons" FLAGS=1 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEBookTexture5	 FILE=TEXTURES\FEBookTexture5.bmp GROUP="Icons" FLAGS=1 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEBookTexture6	 FILE=TEXTURES\FEBookTexture6.bmp GROUP="Icons" FLAGS=1 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=MainTabTexture	 FILE=TEXTURES\MainTabTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FolioTabTexture	 FILE=TEXTURES\FolioTabTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=ReportTabTexture	 FILE=TEXTURES\ReportTabTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=SaveTabTexture	 FILE=TEXTURES\SaveTabTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=ChapterTabTexture	 FILE=TEXTURES\ChapterTabTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=MainTabOverTexture	 FILE=TEXTURES\MainTabOverTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FolioTabOverTexture	 FILE=TEXTURES\FolioTabOverTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=ReportTabOverTexture	 FILE=TEXTURES\ReportTabOverTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=SaveTabOverTexture	 FILE=TEXTURES\SaveTabOverTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=ChapterTabOverTexture	 FILE=TEXTURES\ChapterTabOverTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
...
#EXEC TEXTURE IMPORT NAME=FELegalTexture1	 FILE=TEXTURES\FELegalTexture1.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FELegalTexture2	 FILE=TEXTURES\FELegalTexture2.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FELegalTexture3	 FILE=TEXTURES\FELegalTexture3.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FELegalTexture4	 FILE=TEXTURES\FELegalTexture4.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FELegalTexture5	 FILE=TEXTURES\FELegalTexture5.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FELegalTexture6	 FILE=TEXTURES\FELegalTexture6.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FEEALogoTexture1	 FILE=TEXTURES\FEEALogoTexture1.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEEALogoTexture2	 FILE=TEXTURES\FEEALogoTexture2.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEEALogoTexture3	 FILE=TEXTURES\FEEALogoTexture3.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEEALogoTexture4	 FILE=TEXTURES\FEEALogoTexture4.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEEALogoTexture5	 FILE=TEXTURES\FEEALogoTexture5.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEEALogoTexture6	 FILE=TEXTURES\FEEALogoTexture6.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FELeftReturnUpIcon	 FILE=TEXTURES\FELeftReturnUpIcon.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FELeftReturnOverIcon	 FILE=TEXTURES\FELeftReturnOverIcon.bmp GROUP="Icons" FLAGS=2 MIPS=OFF


#EXEC TEXTURE IMPORT NAME=FEScrollBackTexture1	 FILE=TEXTURES\FEScrollBackTexture1.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEScrollBackTexture2	 FILE=TEXTURES\FEScrollBackTexture2.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEScrollBackTexture3	 FILE=TEXTURES\FEScrollBackTexture3.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEScrollBackTexture4	 FILE=TEXTURES\FEScrollBackTexture4.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEScrollBackTexture5	 FILE=TEXTURES\FEScrollBackTexture5.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEScrollBackTexture6	 FILE=TEXTURES\FEScrollBackTexture6.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FEReportBackTexture1	 FILE=TEXTURES\FEReportBackTexture1.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEReportBackTexture2	 FILE=TEXTURES\FEReportBackTexture2.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEReportBackTexture3	 FILE=TEXTURES\FEReportBackTexture3.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEReportBackTexture4	 FILE=TEXTURES\FEReportBackTexture4.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEReportBackTexture5	 FILE=TEXTURES\FEReportBackTexture5.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEReportBackTexture6	 FILE=TEXTURES\FEReportBackTexture6.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FESaveBackTexture1	 FILE=TEXTURES\FESaveBackTexture1.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FESaveBackTexture2	 FILE=TEXTURES\FESaveBackTexture2.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FESaveBackTexture3	 FILE=TEXTURES\FESaveBackTexture3.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FESaveBackTexture4	 FILE=TEXTURES\FESaveBackTexture4.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FESaveBackTexture5	 FILE=TEXTURES\FESaveBackTexture5.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FESaveBackTexture6	 FILE=TEXTURES\FESaveBackTexture6.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FEOptionsBackTexture1	 FILE=TEXTURES\FEOptionsBackTexture1.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEOptionsBackTexture2	 FILE=TEXTURES\FEOptionsBackTexture2.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEOptionsBackTexture3	 FILE=TEXTURES\FEOptionsBackTexture3.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEOptionsBackTexture4	 FILE=TEXTURES\FEOptionsBackTexture4.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEOptionsBackTexture5	 FILE=TEXTURES\FEOptionsBackTexture5.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEOptionsBackTexture6	 FILE=TEXTURES\FEOptionsBackTexture6.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FEFolioBackTexture1	 FILE=TEXTURES\FEFolioBackTexture1.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEFolioBackTexture2	 FILE=TEXTURES\FEFolioBackTexture2.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEFolioBackTexture3	 FILE=TEXTURES\FEFolioBackTexture3.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEFolioBackTexture4	 FILE=TEXTURES\FEFolioBackTexture4.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEFolioBackTexture5	 FILE=TEXTURES\FEFolioBackTexture5.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEFolioBackTexture6	 FILE=TEXTURES\FEFolioBackTexture6.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FEFolioHarryTexture1	 FILE=TEXTURES\FEFolioHarryTexture1.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEFolioHarryTexture2	 FILE=TEXTURES\FEFolioHarryTexture2.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEFolioHarryTexture3	 FILE=TEXTURES\FEFolioHarryTexture3.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEFolioHarryTexture4	 FILE=TEXTURES\FEFolioHarryTexture4.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEFolioHarryTexture5	 FILE=TEXTURES\FEFolioHarryTexture5.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEFolioHarryTexture6	 FILE=TEXTURES\FEFolioHarryTexture6.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
