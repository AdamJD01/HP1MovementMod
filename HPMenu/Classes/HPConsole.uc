...
#exec TEXTURE IMPORT NAME=MainBackUp FILE=Textures\MainBackUp.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MainBackDown FILE=Textures\MainBackDown.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=MainBackOver FILE=Textures\MainBackOver.bmp GROUP="Icons" MIPS=OFF
...
#exec TEXTURE IMPORT NAME=HPLevelInfoBackground1 FILE=Textures\HPLevelInfoBackground1.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=HPLevelInfoBackground2 FILE=Textures\HPLevelInfoBackground2.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=HPLevelInfoBackground3 FILE=Textures\HPLevelInfoBackground3.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=HPLevelInfoBackground4 FILE=Textures\HPLevelInfoBackground4.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=HPLevelInfoBackground5 FILE=Textures\HPLevelInfoBackground5.bmp GROUP="Icons" MIPS=OFF
#exec TEXTURE IMPORT NAME=HPLevelInfoBackground6 FILE=Textures\HPLevelInfoBackground6.bmp GROUP="Icons" MIPS=OFF
