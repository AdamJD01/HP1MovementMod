...
#EXEC TEXTURE IMPORT NAME=FEQuidBackTexture1	 FILE=TEXTURES\FEQuidBackTexture1.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEQuidBackTexture2	 FILE=TEXTURES\FEQuidBackTexture2.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEQuidBackTexture3	 FILE=TEXTURES\FEQuidBackTexture3.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEQuidBackTexture4	 FILE=TEXTURES\FEQuidBackTexture4.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEQuidBackTexture5	 FILE=TEXTURES\FEQuidBackTexture5.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEQuidBackTexture6	 FILE=TEXTURES\FEQuidBackTexture6.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
...
#EXEC TEXTURE IMPORT NAME=FEGrifLogoMed	 FILE=TEXTURES\FEGrifLogoMed.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEHuffLogoMed	 FILE=TEXTURES\FEHuffLogoMed.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FESlytLogoMed	 FILE=TEXTURES\FESlytLogoMed.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FERaveLogoMed	 FILE=TEXTURES\FERaveLogoMed.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FEGrifLogoSmall	 FILE=TEXTURES\FEGrifLogoSmall.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEHuffLogoSmall	 FILE=TEXTURES\FEHuffLogoSmall.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FESlytLogoSmall	 FILE=TEXTURES\FESlytLogoSmall.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FERaveLogoSmall	 FILE=TEXTURES\FERaveLogoSmall.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FEGrifLogoTiny	 FILE=TEXTURES\FEGrifLogoTiny.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEHuffLogoTiny	 FILE=TEXTURES\FEHuffLogoTiny.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FESlytLogoTiny	 FILE=TEXTURES\FESlytLogoTiny.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FERaveLogoTiny	 FILE=TEXTURES\FERaveLogoTiny.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FEVSTexture	 FILE=TEXTURES\FEVSTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FESmallVSTexture	 FILE=TEXTURES\FESmallVSTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=BroomstickPracticeTexture	 FILE=TEXTURES\BroomstickPracticeTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=QuidLeagueTexture	 FILE=TEXTURES\QuidLeagueTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=BroomstickPracticeLockedTexture	 FILE=TEXTURES\BroomstickPracticeLockedTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=QuidLeagueLockedTexture	 FILE=TEXTURES\QuidLeagueLockedTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
