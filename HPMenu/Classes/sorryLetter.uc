...
#exec TEXTURE IMPORT NAME=sorryLetter1 FILE=TEXTURES\sorryLetter1.BMP GROUP="Icons" FLAGS=2 MIPS=off
#exec TEXTURE IMPORT NAME=sorryLetter2 FILE=TEXTURES\sorryLetter2.BMP GROUP="Icons" FLAGS=2 MIPS=off
