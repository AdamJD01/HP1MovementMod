...
#EXEC TEXTURE IMPORT NAME=BookReportGreenSand	FILE=TEXTURES\BookReportGreenSand.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=BookReportBlueSand	FILE=TEXTURES\BookReportBlueSand.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=BookReportPurpleSand	FILE=TEXTURES\BookReportPurpleSand.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=BookReportRedSand		FILE=TEXTURES\BookReportRedSand.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=BookReportYellowSand	FILE=TEXTURES\BookReportYellowSand.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=BeanBadgeTexture		FILE=TEXTURES\BeanBadgeTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=PointBadgeTexture		FILE=TEXTURES\PointBadgeTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=CardBadgeTexture		FILE=TEXTURES\CardBadgeTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=GreenUpTexture		FILE=TEXTURES\GreenUpTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=BlueUpTexture			FILE=TEXTURES\BlueUpTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=PurpleUpTexture		FILE=TEXTURES\PurpleUpTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=GreenDownTexture		FILE=TEXTURES\GreenDownTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=BlueDownTexture		FILE=TEXTURES\BlueDownTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=PurpleDownTexture		FILE=TEXTURES\PurpleDownTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=GreenOverTexture		FILE=TEXTURES\GreenOverTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=BlueOverTexture		FILE=TEXTURES\BlueOverTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=PurpleOverTexture		FILE=TEXTURES\PurpleOverTexture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
