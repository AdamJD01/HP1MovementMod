...
#EXEC TEXTURE IMPORT NAME=WizCardAdalbertBigTexture		FILE=TEXTURES\WizCardAdalbertBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardBertieBigTexture		FILE=TEXTURES\WizCardBertieBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardBowmanBigTexture		FILE=TEXTURES\WizCardBowmanBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardBurdockBigTexture		FILE=TEXTURES\WizCardBurdockBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardCassandraBigTexture	FILE=TEXTURES\WizCardCassandraBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardCorneliusBigTexture	FILE=TEXTURES\WizCardCorneliusBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardDerwentBigTexture		FILE=TEXTURES\WizCardDerwentBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardDumbledoreBigTexture	FILE=TEXTURES\WizCardDumbledoreBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardEdgarBigTexture		FILE=TEXTURES\WizCardEdgarBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardElladoraBigTexture		FILE=TEXTURES\WizCardElladoraBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardGiffordBigTexture		FILE=TEXTURES\WizCardGiffordBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardGodricBigTexture		FILE=TEXTURES\WizCardGodricBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardHarryBigTexture		FILE=TEXTURES\WizCardHarryBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardHelgaBigTexture		FILE=TEXTURES\WizCardHelgaBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardHengistBigTexture		FILE=TEXTURES\WizCardHengistBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardIgnatiaBigTexture		FILE=TEXTURES\WizCardIgnatiaBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardMerlinBigTexture		FILE=TEXTURES\WizCardMerlinBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardMorganBigTexture		FILE=TEXTURES\WizCardMorganBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardNewtBigTexture			FILE=TEXTURES\WizCardNewtBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardRodericBigTexture		FILE=TEXTURES\WizCardRodericBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardRowenaBigTexture		FILE=TEXTURES\WizCardRowenaBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardSalizarBigTexture		FILE=TEXTURES\WizCardSalizarBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardTillyBigTexture		FILE=TEXTURES\WizCardTillyBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardUricBigTexture			FILE=TEXTURES\WizCardUricBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardHerpoBigTexture		FILE=TEXTURES\WizCardHerpoBigTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=WizCardAdalbertSmallTexture		FILE=TEXTURES\WizCardAdalbertSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardBertieSmallTexture		FILE=TEXTURES\WizCardBertieSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardBowmanSmallTexture		FILE=TEXTURES\WizCardBowmanSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardBurdockSmallTexture		FILE=TEXTURES\WizCardBurdockSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardCassandraSmallTexture	FILE=TEXTURES\WizCardCassandraSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardCorneliusSmallTexture	FILE=TEXTURES\WizCardCorneliusSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardDerwentSmallTexture		FILE=TEXTURES\WizCardDerwentSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardDumbledoreSmallTexture	FILE=TEXTURES\WizCardDumbledoreSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardEdgarSmallTexture		FILE=TEXTURES\WizCardEdgarSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardElladoraSmallTexture		FILE=TEXTURES\WizCardElladoraSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardGiffordSmallTexture		FILE=TEXTURES\WizCardGiffordSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardGodricSmallTexture		FILE=TEXTURES\WizCardGodricSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardHarrySmallTexture		FILE=TEXTURES\WizCardHarrySmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardHelgaSmallTexture		FILE=TEXTURES\WizCardHelgaSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardHengistSmallTexture		FILE=TEXTURES\WizCardHengistSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardIgnatiaSmallTexture		FILE=TEXTURES\WizCardIgnatiaSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardMerlinSmallTexture		FILE=TEXTURES\WizCardMerlinSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardMorganSmallTexture		FILE=TEXTURES\WizCardMorganSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardNewtSmallTexture			FILE=TEXTURES\WizCardNewtSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardRodericSmallTexture		FILE=TEXTURES\WizCardRodericSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardRowenaSmallTexture		FILE=TEXTURES\WizCardRowenaSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardSalizarSmallTexture		FILE=TEXTURES\WizCardSalizarSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardTillySmallTexture		FILE=TEXTURES\WizCardTillySmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardUricSmallTexture			FILE=TEXTURES\WizCardUricSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardHerpoSmallTexture		FILE=TEXTURES\WizCardHerpoSmallTexture.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FolioArrowLeft		FILE=TEXTURES\FolioArrowLeft.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FolioArrowLeftDown	FILE=TEXTURES\FolioArrowLeftDown.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FolioArrowLeftOver	FILE=TEXTURES\FolioArrowLeftOver.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FolioArrowRight		FILE=TEXTURES\FolioArrowRight.bmp			GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FolioArrowRightDown	FILE=TEXTURES\FolioArrowRightDown.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FolioArrowRightOver	FILE=TEXTURES\FolioArrowRightOver.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=WizCardMissingBigTexture		FILE=TEXTURES\WizCardMissingBigTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=WizCardMissingSmallTexture	FILE=TEXTURES\WizCardMissingSmallTexture.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FELeftArrowUpIcon		FILE=TEXTURES\FELeftArrowUpIcon.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FELeftArrowOverIcon		FILE=TEXTURES\FELeftArrowOverIcon.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=FERightArrowUpIcon		FILE=TEXTURES\FERightArrowUpIcon.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FERightArrowOverIcon		FILE=TEXTURES\FERightArrowOverIcon.bmp		GROUP="Icons" FLAGS=2 MIPS=OFF
