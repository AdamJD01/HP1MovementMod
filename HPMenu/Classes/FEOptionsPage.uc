...
#EXEC TEXTURE IMPORT NAME=FEOverOption4Texture	 FILE=TEXTURES\FEOverOption4Texture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEOverOption5Texture	 FILE=TEXTURES\FEOverOption5Texture.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
