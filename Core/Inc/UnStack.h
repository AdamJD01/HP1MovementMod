...
{	
	...
	BYTE*		Code;
	BYTE*		Locals;
	FFrame* _UnknownFrame; // SuperFrame?

	// Constructors.
	FFrame( UObject* InObject );
	FFrame( UObject* InObject, UStruct* InNode, INT CodeOffset, void* InLocals, FFrame* _InUnknownFrame );
