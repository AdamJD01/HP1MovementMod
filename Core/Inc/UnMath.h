...
FQuat CORE_API SlerpQuat(const FQuat &quat1,const FQuat &quat2, float slerp);

/*-----------------------------------------------------------------------------
	FPlace.          
-----------------------------------------------------------------------------*/

// floating point something.
class CORE_API FPlace
{
public:
	// Variables.
	FQuat   Orientation;
	...
	// Constructors.
	FPlace();
	FPlace( const FQuat& InOrientation, const FVector& InPosition );
};
...
// floating point position and rotation.
...
public:
	...
	// Constructors.
	FPosition();
	FPosition( FVector InV, FRotator InR );
};
