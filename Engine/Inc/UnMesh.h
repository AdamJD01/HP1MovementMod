...
class ENGINE_API UMesh : public UBoxPrim
{
	...
	FBox GetCollisionBoundingBox( const AActor* Owner, bool ) const;
	...
	virtual void GetTriVerts( INT, const INT* ) const;
...
//			return Owner->GetSkin( Count );
	...
	virtual void AdjustRootMovement( AActor* Owner, const FVector& );
	virtual FVector AnimCycleMovement( AActor* Owner );
	virtual FCoords GetBoneCoords( AActor* Owner, INT ) const;
...
class ENGINE_API ULodMesh : public UMesh
{
	...
	void GetTriVerts( INT, const INT* ) const;
