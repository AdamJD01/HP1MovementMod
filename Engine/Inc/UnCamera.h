...
class ENGINE_API UViewport : public UPlayer
{
	...
	// KWG.
	virtual void DrawString( DWORD _D, UFont* Font, INT& X, INT& Y, const TCHAR* Text, const FPlane& Color ) {}
	virtual UFont* CreateNativeFont( const TCHAR* FontName, INT Height );

	virtual UBOOL LoadSmackerMovie( const TCHAR* Filename ) { return 0; }
	virtual UBOOL BlitNextSmackerFrame() { return 1; }
	virtual UBOOL ShutdownSmacker() { return 1; }
