...
class ENGINE_API URenderBase : public USubsystem
{
	...
	virtual UBOOL BoundVisible( FSceneNode* Frame, const FCoords& Coords, FSpanBuffer* SpanBuffer, FScreenBounds& Results )=0;
	...
	virtual void DrawCylinder( FSceneNode* Frame, FPlane Color, DWORD LineFlags, const FCoords& Coords, FLOAT, FLOAT, FLOAT )=0;
	virtual void DrawInterpolationPathSegment( FSceneNode* Frame, AInterpolationPoint* StartPoint, AInterpolationPoint* EndPoint, const FPlane& Color, INT );
};
