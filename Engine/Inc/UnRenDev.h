...
class ENGINE_API URenderDevice : public USubsystem
{
	...
	virtual void DrawTriangles( FSceneNode* Frame, FTextureInfo& Info, FTransTexture** Pts, INT NumPts, _WORD* Indices, INT NumIndices, DWORD PolyFlags, class FSpanBuffer* Span )=0;
	...
	virtual void* GetOsSurface( void* _VP, bool _B ) { return NULL; }
