...
enum ESpellType
{
    ...
    SPELL_Ectomatic         =14,
    SPELL_Avifores          =15,
    SPELL_FireCracker       =16,
    SPELL_Transfiguration   =17,
    SPELL_WingSustain       =18,
    SPELL_MAX               =19,
};
enum ENetRole
{
...
class ENGINE_API AParticleFX : public AActor
{
public:
    ...
    DECLARE_CLASS(AParticleFX,AActor,0,Engine)
...
class ENGINE_API UGesture : public UObject
{
public:
    TArray<FVector> Points;
    TArray<INT> Segments;
    DECLARE_FUNCTION(execCompareGesturePoint);
    DECLARE_FUNCTION(execCompareGesture);
    DECLARE_CLASS(UGesture,UObject,0,Engine)
    NO_DEFAULT_CONSTRUCTOR(UGesture)
};
