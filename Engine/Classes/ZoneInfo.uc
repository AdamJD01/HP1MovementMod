...
replication
{
	reliable if( Role==ROLE_Authority )
		...
		// ViewFog  // Not replicated because vectors replicated with elements rounded to integers
		bReverbZone,
		FogColor;
}
...
{
     ZoneGravity=(Z=-512)
     ZoneGroundFriction=8
     ZoneFluidFriction=1.2
     ZoneTerminalVelocity=2500
     MaxCarcasses=3
