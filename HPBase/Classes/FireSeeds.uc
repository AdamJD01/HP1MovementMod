...
#exec MESH  MODELIMPORT MESH=FireSeedMesh MODELFILE=..\hprops\models\FireSeedMesh.PSK LODSTYLE=10
#exec MESH  ORIGIN MESH=FireSeedMesh X=0 Y=0 Z=0 YAW=0 PITCH=0 ROLL=0
#exec ANIM  IMPORT ANIM=FireSeedAnims ANIMFILE=..\hprops\models\FireSeedAnims.PSA COMPRESS=1 MAXKEYS=999999 IMPORTSEQS=1
