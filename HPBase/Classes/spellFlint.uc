...
#EXEC TEXTURE IMPORT NAME=flintSpellIcon  FILE=TEXTURES\flintSpellIcon.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
...
defaultproperties
{
     spellIcon=Texture'HPBase.Icons.flintSpellIcon'
     spellName="Flintifores"
     CastSound=Sound'HPSounds.magic_sfx.Spells.s_spell_throw3'
     ImpactSound=Sound'HPSounds.magic_sfx.Spells.s_spell_hit3'
     Style=STY_Translucent
     Mesh=SkeletalMesh'HPBase.SPELLLEVMesh'
}
