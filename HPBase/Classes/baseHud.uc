...
#EXEC TEXTURE IMPORT NAME=leftPanel  FILE=TEXTURES\leftPanel.bmp GROUP=Icons MIPS=off
#EXEC TEXTURE IMPORT NAME=middlePanel  FILE=TEXTURES\middlePanel.bmp GROUP=Icons MIPS=off
#EXEC TEXTURE IMPORT NAME=rightPanel  FILE=TEXTURES\rightPanel.bmp GROUP=Icons MIPS=off



#EXEC TEXTURE IMPORT NAME=HarryBarFull  FILE=TEXTURES\HarryBarFull.bmp GROUP=Icons MIPS=off GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=HarryBarEmpty  FILE=TEXTURES\HarryBarEmpty.bmp GROUP=Icons MIPS=off GROUP="Icons" FLAGS=2 MIPS=OFF

#EXEC TEXTURE IMPORT NAME=HudTextBox2  FILE=TEXTURES\HUDTextBox2.bmp GROUP=Icons

#EXEC TEXTURE IMPORT NAME=TimerBarFull  FILE=TEXTURES\TimerBarFull.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=TimerBarEmpty  FILE=TEXTURES\TimerBarEmpty.bmp GROUP="Icons" FLAGS=2 MIPS=OFF
