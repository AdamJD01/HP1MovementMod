...
#EXEC TEXTURE IMPORT NAME=FEMessageBoxBg	 FILE=TEXTURES\FEMessageBoxBg.bmp GROUP="Icons" FLAGS=1 MIPS=OFF
#EXEC TEXTURE IMPORT NAME=FEMessageBoxBtn	 FILE=TEXTURES\FEMessageBoxBtn.bmp GROUP="Icons" FLAGS=1 MIPS=OFF
