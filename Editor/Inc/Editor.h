...
class EDITOR_API UEditorEngine : public UEngine, public FNotifyHook
{
	...
	virtual void edSetClickLocation(class FVector& Location );
	...
	virtual void csgRebuild( ULevel* Level, INT );
	...
	virtual void mapSetBrush( ULevel* Level, enum EMapSetBrushFlags PropertiesMask, _WORD BrushColor, FName Group, DWORD SetPolyFlags, DWORD ClearPolyFlags, DWORD );
	...
	virtual void edactApplyTransformToBrush( ABrush* Brush );
	virtual void edactBoxSelect( UViewport* Viewport, ULevel* Level, FVector , FVector );
	...
	virtual INT bspBrushCSG( ABrush* Actor, UModel* Model, DWORD PolyFlags, ECsgOper CSGOper, UBOOL RebuildBounds, INT );
	virtual void bspOptGeom( UModel* Model );
	virtual void bspValidateBrush( UModel* Brush, INT ForceValidate, INT DoStatusUpdate );
	virtual void bspUnlinkPolys( UModel* Model );
	...
	virtual void shadowIlluminateBsp( ULevel* Level, UBOOL Selected, INT );
	...
	virtual void modelImport( const TCHAR* MeshName, UObject* InParent, const TCHAR*, INT, INT, INT, ULODProcessInfo* LODInfo ); 
	...
	virtual void modelLODProcess( USkeletalMesh* Mesh, ULODProcessInfo* LODInfo, USkelImport* SkelImport );
	virtual void meshDropFrames( UMesh* Mesh, INT StartFrame, INT NumFrame );
	virtual void modelAssignWeaponBone( USkeletalMesh* Mesh, FName BoneName );
	virtual void animGetBoneIndex( UAnimation* Anim, FName BoneName );
	virtual void modelSetWeaponPosition( USkeletalMesh* Mesh, FCoords Coords );
	virtual void animationImport( const TCHAR* AnimName, UObject* InParent, const TCHAR*, INT, INT, FLOAT );
	virtual void digestMovementRepertoire( UAnimation* Anim );
	virtual void movementDigest( UAnimation* Anim, INT );
	virtual void patternImport( const TCHAR* PatternName, UObject* InParent, const TCHAR* PatternFName );
	...
	virtual int CheckScripts( FFeedbackContext* Warn, INT, UPackage* );
