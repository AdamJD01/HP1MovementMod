...
#exec MESH  MODELIMPORT MESH=GHallSortHatMesh MODELFILE=models\GHallSortHatMesh.PSK LODSTYLE=10
#exec MESH  ORIGIN MESH=GHallSortHatMesh X=0 Y=0 Z=0 YAW=0 PITCH=0 ROLL=0
#exec ANIM  IMPORT ANIM=GHallSortHatAnims ANIMFILE=models\GHallSortHatAnims.PSA COMPRESS=1 MAXKEYS=999999 IMPORTSEQS=1
...
#EXEC TEXTURE IMPORT NAME=GHallSortHatTex0  FILE=TEXTURES\GHallSortHatTex0.bmp  GROUP=Skins
...
defaultproperties
{
     bStatic=False
     DrawType=DT_Mesh
     Mesh=SkeletalMesh'HProps.GHallSortHatMesh'
}
