...
#exec MESH  MODELIMPORT MESH=FlipendoVaseBronzeMesh MODELFILE=models\FlipendoVaseBronzeMesh.PSK LODSTYLE=10
#exec MESH  ORIGIN MESH=FlipendoVaseBronzeMesh X=0 Y=0 Z=0 YAW=0 PITCH=0 ROLL=0
#exec ANIM  IMPORT ANIM=FlipendoVaseBronzeAnims ANIMFILE=models\FlipendoVaseBronzeAnims.PSA COMPRESS=1 MAXKEYS=999999 IMPORTSEQS=1
...
#EXEC TEXTURE IMPORT NAME=FlipendoVaseBronzeTex0  FILE=TEXTURES\FlipendoVaseBronzeTex0.bmp  GROUP=Skins
