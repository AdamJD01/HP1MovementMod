...
#exec MESH  MODELIMPORT MESH=RememberallBroomMesh MODELFILE=models\RememberallBroomMesh.PSK LODSTYLE=10
#exec MESH  ORIGIN MESH=RememberallBroomMesh X=0 Y=0 Z=0 YAW=0 PITCH=0 ROLL=0
#exec ANIM  IMPORT ANIM=RememberallBroomAnims ANIMFILE=models\RememberallBroomAnims.PSA COMPRESS=1 MAXKEYS=999999 IMPORTSEQS=1
...
#EXEC TEXTURE IMPORT NAME=RememberallBroomTex0  FILE=TEXTURES\RememberallBroomTex0.bmp  GROUP=Skins
