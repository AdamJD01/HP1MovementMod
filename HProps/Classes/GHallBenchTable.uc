...
#exec MESH  MODELIMPORT MESH=GHallBenchTableMesh MODELFILE=models\GHallBenchTableMesh.PSK LODSTYLE=10
#exec MESH  ORIGIN MESH=GHallBenchTableMesh X=0 Y=0 Z=0 YAW=0 PITCH=0 ROLL=0
#exec ANIM  IMPORT ANIM=GHallBenchTableAnims ANIMFILE=models\GHallBenchTableAnims.PSA COMPRESS=1 MAXKEYS=999999 IMPORTSEQS=1
...
#EXEC TEXTURE IMPORT NAME=GHallBenchTableTex0  FILE=TEXTURES\GHallBenchTableTex0.bmp  GROUP=Skins
...
defaultproperties
{
     bStatic=False
     DrawType=DT_Mesh
     Mesh=SkeletalMesh'HProps.GHallBenchTableMesh'
}
