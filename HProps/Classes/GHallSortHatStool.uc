...
#exec MESH  MODELIMPORT MESH=GHallSortHatStoolMesh MODELFILE=models\GHallSortHatStoolMesh.PSK LODSTYLE=10
#exec MESH  ORIGIN MESH=GHallSortHatStoolMesh X=0 Y=0 Z=0 YAW=0 PITCH=0 ROLL=0
#exec ANIM  IMPORT ANIM=GHallSortHatStoolAnims ANIMFILE=models\GHallSortHatStoolAnims.PSA COMPRESS=1 MAXKEYS=999999 IMPORTSEQS=1
...
#EXEC TEXTURE IMPORT NAME=GHallSortHatStoolTex0  FILE=TEXTURES\GHallSortHatStoolTex0.bmp  GROUP=Skins
...
defaultproperties
{
     bStatic=False
     DrawType=DT_Mesh
     Mesh=SkeletalMesh'HProps.GHallSortHatStoolMesh'
}
